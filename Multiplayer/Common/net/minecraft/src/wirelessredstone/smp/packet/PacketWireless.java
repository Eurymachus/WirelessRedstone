...
public class PacketWireless extends PacketUpdate
{
	 ...
	 * 
	 * @param packetId the packet ID used to identify the type of packet data being sent or received
	 */
	...
	/**
	 * Constructor for Default Wireless Packets
	 * Used to add payload data to the packet
	 * 
	 * @param packetId the packet ID used to identify the type of packet data being sent or received
	...
	/**
	 * Retrieves the command from the payload
	 * Override to change the index position
	 * 
	...
	/**
	 * Retrieves the frequency from the payload
	 * Override to change the index position
	 * 
