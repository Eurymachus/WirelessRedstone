...
public abstract class GuiRedstoneWirelessSnifferOverride implements GuiRedstoneWirelessDeviceOverride {

	public abstract boolean beforeSetPage(WirelessDeviceData data, int pageNumber);
}
