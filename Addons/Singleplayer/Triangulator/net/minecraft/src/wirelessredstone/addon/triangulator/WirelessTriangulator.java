...
public class WirelessTriangulator
{
	...
	//public static TextureTriangulatorFX[] tex = new TextureTriangulatorFX[WirelessRedstone.maxEtherFrequencies];
...
/*		for (int i = 0; i < WirelessRedstone.maxEtherFrequencies; ++i)
		{
			tex[i] = new TextureTriangulatorFX(ModLoader.getMinecraftInstance(), i);
			ModLoader.getMinecraftInstance().renderEngine.registerTextureFX(tex[i]);
		}*/
	}
