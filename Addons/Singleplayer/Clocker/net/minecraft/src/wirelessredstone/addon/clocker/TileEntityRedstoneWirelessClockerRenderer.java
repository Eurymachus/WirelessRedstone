...
public class TileEntityRedstoneWirelessClockerRenderer extends
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1,
		...
		GL11.glPushMatrix();
		GL11.glTranslatef((float) d + 0.5F, (float) d1 + 0.58F, (float) d2 + 1F
				+ f4);
		...
		GL11.glPushMatrix();
		GL11.glTranslatef((float) d + 1F + f4, (float) d1 + 0.58F,
				(float) d2 + 0.5F);
