...
public class PacketHandlerWirelessTriangulator {
	...
	public static void handlePacket(PacketUpdate packet)
	{
		if ( packet instanceof PacketWirelessTriangulatorSettings ) {
			PacketHandlerInput.handleWirelessRemote((PacketWirelessTriangulatorSettings)packet);
		}
	}
	

	private static class PacketHandlerInput {
		private static void handleWirelessRemote(PacketWirelessTriangulatorSettings packet)
		{
